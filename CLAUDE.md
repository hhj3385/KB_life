...
### 브랜딩·카피 (2026-05-12 수정사항 반영)
- **재단 풀네임**: "KB 라이프사회공헌재단" (붙여 씀, "KB 라이프"·"KB라이프생명사회공헌재단" X)
- **대회 풀네임**: "전국청소년자원봉사대회" / "KB 라이프 전국청소년자원봉사대회 10기"
- **상단 헤더 (모든 화면 공통)**:
  - 좌상단 작게: 재단 로고 (KB 라이프사회공헌재단)
  - 헤더 아랫줄 가운데: 전국청소년자원봉사대회 로고 + "10기 서포터즈"
- **발급기관명**: "전국청소년자원봉사대회 운영사무국"
- **봉사자증 번호 형식**: `전국청소년자원봉사대회-{year}-{5자리}` (글자 작게)
- **봉사자증 앞면 카드 좌상단**: KB 라이프 로고 → 대회 로고로 대체
- **봉사자증 앞면 카드 타이틀**: "예비 봉사자증" (10기 봉사자증 아님)
- **결과 마지막 화면 / 봉사자증 뒷면 마무리 멘트**:
  > "2026년 전국청소년자원봉사대회, 청소년 여러분의 많은 참여를 기다릴게요!"
- 카드 안내(뒷면 F영역)는 **공식 인스타그램** 박스로 (KB 대회 QR 박스 X)
- 슬로건 사용 X (로고만 분산 배치)

### 자산 위치
- `/image/logos/재단 로고.png` — KB 라이프사회공헌재단
- `/image/logos/전국청소년 자원봉사대회 로고.png` — 대회
- `/image/logos/KB 라이프 로고.png` — (보존만, 화면에서는 사용 안 함)
- `/image/charictor/` — 캐릭터 PNG 100장
