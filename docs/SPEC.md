...
model Session {
  ...
  nickname    String?  // 최대 20자 (선택)
  pledge      String?  // 최대 50자 (필수)
  cardNo      String?  @unique // "전국청소년자원봉사대회-2026-00001" 형식
  issuedAt    DateTime?

  // 대회 안내·홍보용 추가 정보 (2026-05-12 추가, 모두 필수)
...
### 7.1 봉사자증 번호 (2026-05-12 변경)
형식: `전국청소년자원봉사대회-{year}-{5자리}` (예: `전국청소년자원봉사대회-2026-00001`)
- year: 발급 시점 연도
- 5자리: 일련번호 (DB 트랜잭션으로 충돌 방지)
- 봉사자증 카드 안에서는 글자 크기 작게 표시 (한 줄에 자연스럽게 들어가도록)

### 7.2 앞면 구성 요소 (2026-05-12 변경)
- 카드 좌상단: **전국청소년자원봉사대회 로고** (KB 라이프 로고 X)
- 타이틀: **"예비 봉사자증"** ("10기 봉사자증" X)
- 캐릭터 이미지: 누끼(_clear) + 흰 증명사진 프레임 (256×256)
- 입장 사진(폴라로이드 썸네일) — 정책 검토 후 유지 또는 제거 (현재는 유지)
- 닉네임 + 4글자 코드(SAGE/WARM/BOLD/NOVA) 큰 폰트 + 별명 작게
- 봉사 각오 한 줄
- 발급일자 + 좌하단에 작게 `NO. 전국청소년자원봉사대회-{year}-{5자리}`

### 7.3 뒷면 구성 요소 9영역 (2026-05-12 F·G·H 변경)
A. 헤더 — 좌상단 재단 로고 + "BACK SIDE" 라벨
B. 결과 헤드라인 — 4글자 코드 큰 폰트 + 별명 + 미니 캐릭터(누끼, 48px)
C. 마이크로 카피 — 따옴표 인용구 박스 (유형 컬러)
D. 유형 설명 4줄
E. 추천 봉사 카드 3개
F. **공식 인스타그램 박스** — "전국청소년자원봉사대회 공식 인스타그램" 헤드 + 우측에 인스타 링크/팔로우 버튼 (KB 대회 QR 박스 → 인스타로 교체)
G. 마무리 멘트 — **"2026년 전국청소년자원봉사대회, 청소년 여러분의 많은 참여를 기다릴게요!"**
H. 발급 정보 (작게):
   - NO. `전국청소년자원봉사대회-{year}-{5자리}`
   - 발급일
   - 발급기관: **전국청소년자원봉사대회 운영사무국**
I. 액션 버튼 (앞면 보기 / 저장 / 공유) + 메인 CTA "경품 뽑기존으로 가기"
